...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 7436405160040568996),
      name: 'Note',
      lastPropertyId: const IdUid(3, 634658017698169307),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3626981118586743913),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 2410198538062244922),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 634658017698169307),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 7436405160040568996),
